  ...
  const PROMPTS = [
    {
      ...
      text:
        "O gato dorme na rua.   A lua brilha no telhado.    Um carro passa devagar.     O gato abre um olho e boceja.   Tudo volta a ficar quieto.",
    },
    {
      title: "Manhã de Escola",
      text:
         "O sol entra pela janela.  Lia veste a blusa azul. O pai prepara o café.   Ela corre, ri e pega a mochila. O dia está só começando.",
    },
    {
      title: "Chuva na Praça",
      text:
        "A chuva cai fininha.   As árvores dançam com o vento.  Um menino pula na poça. A mãe chama, ele responde sorrindo. Cheiro de terra molhada no ar.",
    },
  ];
